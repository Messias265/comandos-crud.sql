...
--
-- Host: localhost
-- Tempo de geração: 08/09/2026 às 14:27
...
(3, 'sim', '2026-09-08 09:33:38', 'inteligencia-artificial.jpg', 'A inteligência artificial vem se tornando cada vez mais presente na rotina das pessoas. Ferramentas de IA podem ajudar em pesquisas, estudos, organização de tarefas e criação de conteúdos. Com o avanço da tecnologia, novos recursos devem continuar surgindo e facilitando diversas atividades.', 'Inteligência artificial ganha espaço no dia a dia', 'Ferramentas de inteligência artificial estão sendo utilizadas em atividades cotidianas.', 3, 1),
...
(1, 'ana@email.com', 'Ana silva', 'editor', '123abc'),
(2, 'bruno@email.com', 'Bruno Souza', 'admin', 'abc456'),
(3, 'carla@email.com', 'Carla Mendes', 'editor', '789xyz');
